                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php foreach ($users as $user):?>
                                <tr>
                                    ...
                                    <td><?php echo ($user->active) ? anchor("remove-user/{$user->id}", lang('index_active_link')) : anchor("activate/{$user->id}", lang('index_inactive_link'));?></td>
                                    <td><?php echo anchor("update-user/{$user->id}", 'Edit') ;?></td>
                                </tr>
                            <?php endforeach;?>
                        </table>
                        <div class="btn btn-group">
                            <?php echo anchor('add-user', lang('index_create_user_link'), 'class="btn btn-theme"')?>
                            <?php echo anchor('add-group', lang('index_create_group_link'), 'class="btn btn-theme"')?>
                        </div>
                    </div>
