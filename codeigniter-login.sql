...
INSERT INTO `login_attempts` VALUES (3,'127.0.0.1','nitishk879',1568798161);
...
INSERT INTO `users` VALUES (1,'127.0.0.1','admin','$2y$12$.e3VBnS4h4eEjJpV7gkuI.1Eu7JOg4LWlFQPPwxwMkg2kKa0VKMvm','admin@admin.com',NULL,'',NULL,NULL,NULL,'1cc602b6c8d339bc1d2a09533ffc2248767f0794','$2y$10$Mkbxq75N8If6SZA3DBLTDeW5KEOAtBGbfXbBsyNIquWzzuRlcJTm6',1268889823,1568798170,1,'Admin','istrator','ADMIN','123456789');
...
CREATE TABLE `website_details` (
  ...
  `web_name` varchar(96) DEFAULT NULL,
  `web_copyrights` varchar(96) DEFAULT NULL,
  PRIMARY KEY (`web_id`),
  UNIQUE KEY `website_details_web_id_uindex` (`web_id`)
...
CREATE TABLE `website_pages` (
  ...
  `page_title` varchar(155) DEFAULT NULL,
  `page_slug` varchar(155) DEFAULT NULL,
  PRIMARY KEY (`page_id`),
  UNIQUE KEY `website_pages_page_id_uindex` (`page_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-09-20 12:59:57
